...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
/*Nested function can access the varible internal because nestedFunction is nested inside of myFunction, so if nestedFunction doesn't have the varibale it will go out of function and look outside of function and if the other function has it, it will get it from there*/ 
...
const zooAnimals = [
  ...
  */
  ...
  function lowPopulationAnimals(array){
    const pops=array.filter(function(item){
